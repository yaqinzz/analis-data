...
1. Clone repository ini ke komputer lokal Anda menggunakan perintah berikut:
   ...
   ```shell
   git clone https://github.com/yaqinzz/analis-data.git
   ```
...
1. Masuk ke direktori proyek (Local):
   ...
   Atau bisa dengan kunjungi website ini [Project Data Analytics](https://yaqinzz-analis-data-dashboarddashboard-1b6ehz.streamlit.app/)
